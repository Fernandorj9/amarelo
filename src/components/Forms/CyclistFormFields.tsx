...
export function CyclistFormFields() {
  ...
  useEffect(() => {
    if (cep.length === 9) {
      ...
      axios.get(`https://viacep.com.br/ws/${c}/json/`)
        .then(res => {
          // console.log(res.data);
          setValue(CYCLIST_SCHEMA.CITY, res.data.localidade, { shouldDirty: true });
          setValue(CYCLIST_SCHEMA.STATE, res.data.uf, { shouldDirty: true });
          setValue(CYCLIST_SCHEMA.STREET, res.data.logradouro, { shouldDirty: true });
